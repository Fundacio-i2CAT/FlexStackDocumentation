...
.. code:: py
    ...
    # Geonet
    mac_address = b"\x00\x00\x00\x00\x00" + bytes([args.station_id])
    mib = MIB()
    gn_addr = GNAddress()
    ...
    # Link-Layer
    ll = RawLinkLayer(iface="lo", mac_address=mac_address,
    ...
    device_data_provider = DeviceDataProvider(station_id=args.station_id)
